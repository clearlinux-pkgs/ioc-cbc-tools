...
#
Name     : ioc-cbc-tools
Version  : 2018ww43.3.wa
Release  : 13
URL      : https://github.com/intel/ioc-cbc-tools/archive/2018ww43.3-wa.tar.gz
Source0  : https://github.com/intel/ioc-cbc-tools/archive/2018ww43.3-wa.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause
Requires: ioc-cbc-tools-autostart = %{version}-%{release}
Requires: ioc-cbc-tools-bin = %{version}-%{release}
Requires: ioc-cbc-tools-config = %{version}-%{release}
...
%prep
%setup -q -n ioc-cbc-tools-2018ww43.3-wa
...
export LANG=C
export SOURCE_DATE_EPOCH=1540373470
make  %{?_smp_mflags}
