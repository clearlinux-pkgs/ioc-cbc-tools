...
Version  : 2018ww49.4
Release  : 19
URL      : https://github.com/intel/ioc-cbc-tools/archive/2018ww49.4.tar.gz
Source0  : https://github.com/intel/ioc-cbc-tools/archive/2018ww49.4.tar.gz
...
%prep
%setup -q -n ioc-cbc-tools-2018ww49.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1544069937
make  %{?_smp_mflags}
