...
Version  : 2018ww37.5
Release  : 8
URL      : https://github.com/intel/ioc-cbc-tools/archive/2018ww37.5.tar.gz
Source0  : https://github.com/intel/ioc-cbc-tools/archive/2018ww37.5.tar.gz
...
%prep
%setup -q -n ioc-cbc-tools-2018ww37.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1536911865
make  %{?_smp_mflags}
