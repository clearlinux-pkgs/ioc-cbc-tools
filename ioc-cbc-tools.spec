...
Version  : 2019ww16.1
Release  : 26
URL      : https://github.com/intel/ioc-cbc-tools/archive/2019ww16.1.tar.gz
Source0  : https://github.com/intel/ioc-cbc-tools/archive/2019ww16.1.tar.gz
...
%prep
%setup -q -n ioc-cbc-tools-2019ww16.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1555312148
...
%files
%defattr(-,root,root,-)
/usr/lib/systemd/system-sleep/cbc_thermald_suspend
...
/usr/lib/systemd/system/cbc_thermal_fuse.service
